...
public class BillPdfExporter {
    public void export(Bill bill, OutputStream outputStream) throws Exception {
        ...
        patientTable.addCell(createCell("Name: " + bill.getPatient().getUser().getFullName(), normalFont));
        patientTable.addCell(createCell("Phone: " + bill.getPatient().getUser().getPhone(), normalFont));
        ...
        if (bill.getAppointment() != null) {
            ...
            appTable.addCell(createCell("Doctor: " + bill.getAppointment().getDoctor().getUser().getFullName(), normalFont));
            ...
            labTable.addCell(createCell("Requested by: " + bill.getLabRequest().getDoctor().getUser().getFullName(), normalFont));
